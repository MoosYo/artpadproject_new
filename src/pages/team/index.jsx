    ...
    return (
        <>
                    ...
                    <div className={teamPage__memberInfoBlock}>
                        ...
                        <div className={teamPage__memberLevel}>
                            ...
                            <Progressbar
                                value={level}
                                showPercents={true}
                                className={teamPage__memberLevelProgress}
                            />
                            <p className={teamPage__memberLevelName}>Leader</p>
                        </div>
                        <p className={teamPage__memberInvitedBy}>
                ...
                <Layout direction="vertical">
                    <Container className={teamPage__numbersDataBlock}>
                        ...
                        <p className={teamPage__numbersDataValue}>
                            ...
                            <span className={teamPage__numbersDataValue_small}> / {activeMembers.toLocaleString("ru-RU")}</span>
                        </p>
                    </Container>
                    <Container className={teamPage__numbersDataBlock}>
            ...
            <div className={teamPage__listNav}>
                ...
                ><span className={teamPage__listNavLinksText}>All</span>&nbsp;({totalMembers.toLocaleString("ru-RU")})</a>
                <a
                    href="#activated"
                    onClick={()=>setActiveList("activated")}
                    className={teamPage__listNavLinks + (activeList === "activated" ? " " + teamPage__listNavLinks_active : "")}
                ><span className={teamPage__listNavLinksText}>Activated</span>&nbsp;({activeMembers.toLocaleString("ru-RU")})</a>
                <a
                    href="#not-activated"
                    onClick={()=>setActiveList("not-activated")}
                    className={teamPage__listNavLinks + (activeList === "not-activated" ? " " + teamPage__listNavLinks_active : "")}
                ><span className={teamPage__listNavLinksText}>Not activated</span>&nbsp;({(totalMembers - activeMembers).toLocaleString("ru-RU")})</a>
            </div>
        </>
    );
}